...
$sql="SELECT * from admin Where login ='$email' AND mdp='$password'";
$results=$connect->query($sql);
$final=$results->fetch_assoc();

$_SESSION['email']=$final['login'];
$_SESSION['password']=$final['mdp'];



if($email=$final['login'] AND $password=$final['mdp']){
